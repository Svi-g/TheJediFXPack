...
// Create two image-based buttons.
        Button btnHourglass = new Button("Hourglass",
                new ImageView("/Users/siviwematho/Documents/GitHub/IdeaProjects/TheJediPack/Hourglass.png"));
        Button btnAnalogClock = new Button("Analog Clock",
                new ImageView("/Users/siviwematho/Documents/GitHub/IdeaProjects/TheJediPack/analog.png"));
...
// Handle the action events for the hourglass button.
        btnHourglass.setOnAction(ae -> response.setText("Hourglass Pressed"));
// Handle the action events for the analog clock button.
        btnAnalogClock.setOnAction(ae -> response.setText("Analog Clock Pressed"));
